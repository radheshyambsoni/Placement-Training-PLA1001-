...
class Test {
    // This methid finds all primes smaller than 'limit' using simple sieve of eratosthenes. It also stores found primes in vector prime[]
    static void simpleSieve(int limit, Vector<Integer> prime) {
        // Create a boolean array "mark[0..n-1]" and initialize all entries of it as
        // true. A value in mark[p] will finally be false if 'p' is Not a prime, else
        // true.
